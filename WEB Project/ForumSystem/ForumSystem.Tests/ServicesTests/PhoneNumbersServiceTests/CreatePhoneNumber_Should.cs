...
{
    [TestClass]
    public class CreatePhoneNumber_Should
    {
        [TestMethod]
        public void Should_CreatePhoneNumber_When_UserIsAdmin()
        {
            // Arrange
            ...
            repositoryMock
                .Setup(n => n.Create(expectedPhoneNumber))
            ...
            PhoneNumberDto actualPhoneNumber = numbersSystemSut.Create(expectedPhoneNumber, expectedPhoneNumber.User);
        ...
        public void ThrowsException_When_UserIsNotAdmin()
        {
            ...
            repositoryMock
                .Setup(n => n.Create(expectedPhoneNumber))
                .Throws(new UnauthorizedOperationException("You are not authorized to add a phone number!"));

            var numbersSystemSut = new PhoneNumbersService(repositoryMock.Object, modelMapperMock.Object);


            // Act && Assert
            Assert.ThrowsException<UnauthorizedOperationException>(() => numbersSystemSut.Create(expectedPhoneNumber, expectedPhoneNumber.User));
        }
