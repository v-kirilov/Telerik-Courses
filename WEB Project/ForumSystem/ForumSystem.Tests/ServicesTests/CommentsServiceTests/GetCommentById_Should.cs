...
namespace ForumSystem.Tests.ServicesTests.CommentsServiceTests
{
    ...
    {
        [TestMethod]
        public void Should_GetCommentById_When_IdIsValid()
        {
            // Arrange
            ...
            repositoryMock
                .Setup(r => r.GetCommentById(expectedComment.PostId, expectedComment.Id))
            ...
            // Act
            CommentDto actualCommentDto = commentServiceSut.GetById(expectedComment.PostId, expectedComment.Id);
        ...
        public void ThrowException_When_CommentNotFound()
        {
            ...
            repositoryMock
                .Setup(c => c.GetCommentById(It.IsAny<int>(), It.IsAny<int>()))
            ...
            // Act & Assert
            Assert.ThrowsException<EntityNotFoundException>(() => commentServiceSut.GetById(It.IsAny<int>(), It.IsAny<int>()));
        }
    }
}
