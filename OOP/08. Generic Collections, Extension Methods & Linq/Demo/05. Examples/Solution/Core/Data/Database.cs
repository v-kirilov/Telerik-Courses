...
namespace Linq.Examples.Data
{
    public static class Database
    {
        ...
        private static List<Customer> CreateCustomersList()
        {
            // Customer/Order data read into memory from XML file using XLinq:
            return (
                from e in XDocument
                    .Load("../../../../Core/Data/Customers.xml")
        ...
        private static List<Supplier> CreateSuppliersList()
        {
